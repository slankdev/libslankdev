...
inoremap <C-BS> <Del>
nnoremap  :copen
nnoremap  :call SwitchQuickfixWindow()
smap  <Plug>(neosnippet_expand_or_jump)
snoremap  a<BS>
smap <expr> 	 neosnippet#jumpable() ? "\<Plug>(neosnippet_expand_or_jump)" : "\	"
snoremap  a<BS>
xnoremap <silent>  :EasyAlign
nnoremap  :NERDTreeToggle
nnoremap  :GtagsCursor " push jump
...
xnoremap ; :
onoremap ; :
nnoremap D :Unite outline
nnoremap F :Unite buffer
nnoremap H :vertical resize -3
nnoremap J :resize +3
nnoremap K :resize -3
nnoremap L :vertical resize +3
...
nnoremap <F2> :vsw:VimShell
nnoremap <F1> :VimShellPop
inoremap  
imap  <Plug>(neosnippet_expand_or_jump)
inoremap  <Left>
cnoremap  <Left>
imap <expr> 	 pumvisible() ? "\" : neosnippet#jumpable() ? "\<Plug>(neosnippet_expand_or_jump)" : "\	"
cnoremap <NL> <Down>
cnoremap  <Up>
cnoremap  <Right>
